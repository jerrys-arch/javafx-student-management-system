...
public class AdminController {
    ...
    @FXML
    void handleAssignUser(ActionEvent event) {
        loadContent("assignUser.fxml");
    }

    @FXML
    void handleAttendanceReport(ActionEvent event) {
        loadContent("attendanceReport.fxml");
    }

    @FXML
    void handleGradeReport(ActionEvent event) {
        loadContent("gradeReport.fxml");
    }
